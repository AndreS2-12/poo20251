...
public class Impresion extends Producto {
    ...
    private Foto foto;
    private ArrayList<Foto> listaFoto = new ArrayList<Foto>(); // Arreglo de fotos se declara como arreglo porque tendra
                                                               // x cantidad de productos.

    // Método
    // Contructor: que lo reconocemos porque tiene el mismo nombre que la clase y no
    ...
    // sirve para devolver una representación en forma de texto del objeto. Es
    // decir,
    // cuando tú quieras ver el contenido de un objeto de forma entendible, usas
    // este método.
public String toString() {
    ...
    return salida += "Precio Bruto: { " + getPrecio() + " } \nPrecio Neto: { " + getValorTotal() + " }";
    }
} 